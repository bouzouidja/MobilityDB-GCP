# Scaling moving object database on Google Cloud Platform
In this repository we define an API that allows scaling moving object database in GCP. PostgreSQL server is used as an RDBMS accompanied with MobilityDB extension that support manipulation of moving object data efficiently. For more information about MobilityDB extension for PostgreSQL, you could view [here](https://github.com/MobilityDB) the implementation and the documention.
